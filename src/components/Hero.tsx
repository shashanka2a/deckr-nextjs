        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="relative order-1 lg:order-2">
            <div className="relative z-10 transform hover:scale-105 transition-transform duration-500 ease-out">
              <div className="rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-slate-50 to-white p-8 border border-slate-100">
                {/* AI Pitch Generation Demo */}
                <div className="relative w-full h-96 lg:h-[500px] flex items-center justify-center">
                  
                  {/* Input: Business Idea */}
                  <div className="absolute left-4 top-8 w-32 h-20 bg-white rounded-xl border-2 border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 text-xs text-slate-500 font-medium">Your Idea</div>
                  </div>
                  
                  {/* AI Processing */}
                  <div className="relative w-40 h-24 bg-gradient-to-r from-teal-50 to-blue-50 rounded-xl border-2 border-teal-200 shadow-xl">
                    ...
                    <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 text-xs text-teal-600 font-medium">AI Processing</div>
                  </div>
                  
                  {/* Output: Pitch Deck */}
                  <div className="absolute right-4 bottom-8 w-36 h-20 bg-white rounded-xl border-2 border-teal-300 shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 text-xs text-teal-600 font-medium">Pitch Deck</div>
                  </div>
                  
                  {/* AI Magic Arrow */}
                  <div className="absolute left-40 top-16 w-20 h-0.5 bg-gradient-to-r from-teal-300 to-blue-300">
                    <div className="absolute right-0 top-0 w-0 h-0 border-l-4 border-l-blue-300 border-t-2 border-t-transparent border-b-2 border-b-transparent"></div>
                  </div>
                  <div className="absolute right-44 bottom-16 w-20 h-0.5 bg-gradient-to-r from-teal-300 to-blue-300">
                  ...
                  <div className="absolute top-4 right-8 w-3 h-3 bg-teal-400 rounded-full animate-bounce"></div>
                  <div className="absolute bottom-4 left-8 w-2 h-2 bg-blue-400 rounded-full animate-bounce delay-500"></div>
                </div>
              </div>
            </div>
